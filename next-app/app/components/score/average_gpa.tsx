    ...
    <div className='xl:ml-16 flex flex-col flex-grow '>
      <div className="flex mt-20 mr-10 items-center space-x-16 mb-3">
        ...
        <div className='flex flex-1 space-x-10 text-gray-400 text-lg'>
          <p className='flex ml-auto items-center'><span className="inline-block w-6 h-6 bg-gray-400 rounded-full"></span> Previous week</p> 
          <p className='flex items-center'><span className="inline-block w-6 h-6 bg-black rounded-full"></span> This week</p>  
        </div>
      </div>
      <GPAChart />
    </div>
