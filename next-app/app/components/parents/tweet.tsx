  ...
  return (
    <div className='p-5'>
        ...
        <div className='flex ml-12 mt-4 items-center'>
          {/* make avatars ovelap eachother a little bit */}
          <div className="flex items-center">
            <img 
          ...
          <button className="max-h-9 ml-auto px-4 py-1 bg-gray-100 text-black rounded-full whitespace-nowrap shadow-sm border border-gray-200 hover:bg-gray-200">
            + Add to calendar
        </button>
        </div>
    </div>
